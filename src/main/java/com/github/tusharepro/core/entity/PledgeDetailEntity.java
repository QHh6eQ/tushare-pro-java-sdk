...
public class PledgeDetailEntity implements PledgeDetail {
    ...
    @Id
    @Column(name = "pledge_amount") protected Double pledgeAmount;  // 质押数量
    @Id
    ...
    @Column(name = "holding_amount") protected Double holdingAmount;  // 持股总数
    @Column(name = "pledged_amount") protected Double pledgedAmount;  // 质押总数
