 ...
 * 指数成分和权重
 */
public final class IndexWeigthRequest extends Request<IndexWeigthRequest> {

    public IndexWeigthRequest() {
        this(null);
    }

    public IndexWeigthRequest(TusharePro tusharePro) {
        super(tusharePro);
        setApi_name("index_weigth");
    }
