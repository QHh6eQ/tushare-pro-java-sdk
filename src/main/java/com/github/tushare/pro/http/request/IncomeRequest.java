 ...
 * 利润表
 */
public final class IncomeRequest extends Request<IncomeRequest> {

    public IncomeRequest() {
        this(null);
    }

    public IncomeRequest(TusharePro tusharePro) {
        super(tusharePro);
        setApi_name("income");
    }
    ...
    public static class Params {
        ...
        public static final report_type report_type = new report_type();  // 报告类型： 参考下表说明
